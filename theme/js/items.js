$('#save,#update').on("click",function (e) {
	if (confirm('Are you sure sales price is correct?')) {
	...
	if(item_group=='Single'){
		...
		if(!validate_variants_records(this.id) && this_id=="save"){
   ...
   // var this_id=this.id;
    ...
    if(item_group=='Variants'){
    	...
    	if(existing_row_count==1 && this_id=="save"){
...
function validate_variants_records(this_id){
   var rowcount=$("#hidden_rowcount").val();     
   ...
   if(available_rows==0  && this_id=="save"){
