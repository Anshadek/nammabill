...
//==================check customer numnber length==========================
function check_mob_length(){
  var mob = $('#mobile').val();
    if(mob.length == 10 ) //Also check Others????
        {
        $('#mobile_msg').fadeOut(200).hide();
        $('#mobile_msg').css({'background-color' : '#FFFFFF'});    //White color
        $('#save').show();
        }
        else
        {
        $('#mobile_msg').fadeIn(200).show().html('Mobile number not valid..!').addClass('required');
            $('#mobile_msg').css({'background-color' : '#E8E2E9'});
        $('#save').hide();
