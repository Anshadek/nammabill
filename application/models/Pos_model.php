		...
		$CI =& get_instance();
	      ...
	      if($q2->num_rows()>0){
	        foreach($q2->result() as $res2){
	        	...
	        	$table .= '<div class="col-md-4  col-xs-6 " id="item_parent_'.$i.'" '.$disabled.' data-toggle="tooltip" style="padding-left:5px;padding-right:5px;" title="'.$res2->item_name.'">
	          <div class="box box-default item_box" id="div_'.$res2->id.'" onclick="'.$str.'"
	          				...
	          				data-discount="'.$discount.'"
	           				style="max-height: 180px;min-height: 175px;cursor: pointer;'.$bg_color.'">
	            ...
	            <div class="box-body box-profile">
	              ...
	              </span><br><span class="" style="font-family: sans-serif;color:red;font-size:100%" >'.$expire_date.'</span>
	            </div>
