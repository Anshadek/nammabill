    ...
    public function import_items_csv() {
                ...
                {   
                    ...
                    while(($importdata = fgetcsv($file, NULL, ",")) !== FALSE){
                        ...
                        $sales_price = !empty($this->xss_html_filter($importdata[13]))?$this->xss_html_filter($importdata[13]):0;
                        $purchase_price = !empty($this->xss_html_filter($importdata[9]))?$this->xss_html_filter($importdata[9]):0;
                        $mrp = !empty($this->xss_html_filter($importdata[20]))?$this->xss_html_filter($importdata[20]):0;
                        //Calculate Profit Margin
                        $profit_margin = ($sales_price-$purchase_price);
                        $profit_margin = ($profit_margin>0) ? ($profit_margin/$purchase_price)*100 : 0;
                        ...
                        $row = array(
                            ...
                            'price'             =>  !empty($this->xss_html_filter($importdata[8]))?$this->xss_html_filter($importdata[8]):0,//Actual Price
                            'tax_id'            =>  $tax_id,//10 //ok
                            ...
                            'discount'    =>  !empty($this->xss_html_filter($importdata[19]))?$this->xss_html_filter($importdata[19]):0,//ok
