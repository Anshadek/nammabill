...
<small class="label bg-green">new</small>
    ...
    <?php if($CI->permissions('supplier_items_report') || $CI->permissions('sales_report') || $CI->permissions('item_sales_report') || $CI->permissions('purchase_report') || $CI->permissions('purchase_return_report') || $CI->permissions('expired_items_report') || $CI->permissions('expense_report') || $CI->permissions('profit_report') || $CI->permissions('stock_report') || $CI->permissions('purchase_payments_report') || $CI->permissions('sales_payments_report')  || $CI->permissions('seller_points_report') || $CI->permissions('customer_orders_report') ) { ?>
    <li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-supplier_items-active-li report-seller-points-active-li report-sales-tax-active-li report-purchase-tax-active-li  report-delivery-sheet-active-li report-load-sheet-active-li report-return-item-active-li report-sales-active-li  reports-menu treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php if($CI->permissions('delivery_sheet_report')) { ?>
            ...
            <?php if($CI->permissions('load_sheet_report')) { ?>
            ...
            <?php } ?>
            <li class="report-stock-active-li"><a href="<?php echo $base_url; ?>reports/top_trending_items" ><i class="fa fa-files-o "></i> <span>Top Trending Items</span>
              </a></li>
            ...
            <?php } ?>
           <!-- if($CI->permissions('expired_items_report')) -->
             <li class="report-expired-items-active-li"><a href="<?php echo $base_url; ?>reports/item_expired" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('expired_items_report'); ?></span></a></li>
             <!-- }  -->
         </ul>
      </li>
      <?php } ?>
