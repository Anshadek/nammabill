...
<!-- iCheck -->
  ...
  <style type="text/css">
    ...
    .bg-primary {
    color: #fff;
    background-color: #1b3585!important;
}
...
function addrow(id='',item_obj=''){
    ...
    var quantity        ='<div class="input-group input-group-sm"><span class="input-group-btn"><button onclick="decrement_qty('+item_id+','+rowcount+')" type="button" class="btn btn-default btn-flat"><i class="fa fa-minus text-danger"></i></button></span>';
        quantity       +='<input typ="text" value="1" class="form-control no-padding text-center min_width" onchange="item_qty_input('+item_id+','+rowcount+')" id="item_qty_'+item_id+'" name="item_qty_'+item_id+'">';
...
function final_total(){
  ...
  var coupon_amt = discount_coupon_tot(subtotal);
      subtotal -=coupon_amt;
    console.log("coupon_amt="+coupon_amt);
  //console.log("set_total("+item_qty+","+total+","+discount_amt+","+total+","+discount_amt+");");
...
function adjust_payments(){
  ...
  $(".sales_div_tot_qty").html(item_qty.toFixed(2));
