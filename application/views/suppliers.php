                           ...
                           <div class="row">
                              <div class="col-md-5">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" onkeyup="check_mob_length()" class="form-control no_special_char_no_space" id="mobile" name="mobile" placeholder="+1234567890" value="<?php print $mobile; ?>" >
